...
const CATALOG_ENTITIES = Object.freeze([
  ...
  { uid: 'api::lining.lining', collection: 'linings', fields: ['liningType', 'price_per_metre', 'colour', 'thumbnail', 'pricing_rule', 'key', 'display_name', 'active', 'sort_order', 'is_configurator_option', 'applies_to_curtains', 'applies_to_blinds', 'lining_colour_options'] },
  { uid: 'api::lining-colour.lining-colour', collection: 'lining-colours', fields: ['key', 'display_name', 'hex', 'active', 'sort_order', 'blackout', 'surcharge_per_metre', 'applies_to_curtains', 'applies_to_blinds', 'thumbnail', 'compatible_lining_types'] },
