...
export interface ApiBlindTypeBlindType extends Struct.CollectionTypeSchema {
  collectionName: 'blind_types';
  info: {
    displayName: 'Blind Type';
    pluralName: 'blind-types';
    singularName: 'blind-type';
  };
  options: {
...
export interface ApiCareInstructionCareInstruction
  ...
  info: {
    displayName: 'Care Instruction';
    pluralName: 'care-instructions';
    singularName: 'care-instruction';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiCurtainTypeCurtainType extends Struct.CollectionTypeSchema {
  ...
  info: {
    displayName: 'Curtain Type';
    pluralName: 'curtain-types';
    singularName: 'curtain-type';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiCushionTypeCushionType extends Struct.CollectionTypeSchema {
  ...
  info: {
    ...
    pluralName: 'cushion-types';
    singularName: 'cushion-type';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiCushionCushion extends Struct.CollectionTypeSchema {
  collectionName: 'cushions';
  info: {
    displayName: 'Cushion';
    pluralName: 'cushions';
    singularName: 'cushion';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    cushion_type: Schema.Attribute.Relation<
      'oneToOne',
      'api::cushion-type.cushion-type'
    >;
    fabrics: Schema.Attribute.Relation<'manyToMany', 'api::fabric.fabric'>;
...
export interface ApiFabricFabric extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    usableWidth_cm: Schema.Attribute.Decimal & Schema.Attribute.Required;
  };
}
...
export interface ApiLiningLining extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    colour: Schema.Attribute.String & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    fabrics: Schema.Attribute.Relation<'manyToMany', 'api::fabric.fabric'>;
...
export interface ApiMechanisationMechanisation
  extends Struct.CollectionTypeSchema {
  collectionName: 'mechanisations';
  info: {
    displayName: 'Mechanisation';
    pluralName: 'mechanisations';
    singularName: 'mechanisation';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    billingAddress: Schema.Attribute.String & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiTrimmingTrimming extends Struct.CollectionTypeSchema {
  collectionName: 'trimmings';
  info: {
    displayName: 'Trimming';
    pluralName: 'trimmings';
    singularName: 'trimming';
  };
  options: {
    draftAndPublish: true;
  };
