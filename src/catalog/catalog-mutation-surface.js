...
const CATALOG_ENTITIES = Object.freeze([
  ...
  { uid: 'api::lining.lining', collection: 'linings', fields: ['liningType', 'price_per_metre', 'colour', 'thumbnail', 'pricing_rule'] },
  { uid: 'api::trimming.trimming', collection: 'trimmings', fields: ['type', 'price'] },
  { uid: 'api::mechanisation.mechanisation', collection: 'mechanisations', fields: ['name', 'price', 'thumbnail'] },
  { uid: 'api::curtain-type.curtain-type', collection: 'curtain-types', fields: ['name', 'price', 'thumbnail', 'fullness_multiplier'] },
  { uid: 'api::blind-type.blind-type', collection: 'blind-types', fields: ['name', 'thumbnail'] },
  { uid: 'api::cushion-type.cushion-type', collection: 'cushion-types', fields: ['name', 'types', 'width_cm', 'height_cm'] },
  { uid: 'api::cushion-size.cushion-size', collection: 'cushion-sizes', fields: ['name', 'width_cm', 'height_cm', 'shape', 'thumbnail'] },
  { uid: 'api::cushion-piping.cushion-piping', collection: 'cushion-piping-types', fields: ['name', 'type', 'price', 'thumbnail'] },
  { uid: 'api::cushion-pad.cushion-pad', collection: 'cushion-pads', fields: ['name', 'type', 'price', 'thumbnail'] },
